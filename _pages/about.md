...
- **Multi-Agent Systems & Auto Research:** Rather than focusing solely on end-to-end automated scientific research, I aim to enhance the quality of research ideas—specifically their novelty and practical feasibility. I achieve this by orchestrating intelligent agents and designing effective workflows. Concurrently, I am working to improve the generalization capabilities of multi-agent systems. By making them applicable across a broader spectrum of natural science domains, we can accelerate the pace of scientific discovery.
