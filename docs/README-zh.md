...
## 主要特点
<!-- TODO（中文）：暂无 Google Scholar 主页，暂时注释掉 Google Scholar 引用统计功能说明。
...
<!-- TODO（中文）：暂无 Google Scholar 主页，暂时注释掉 Google Scholar 引用爬虫配置说明。
1. 配置谷歌学术引用爬虫：
...
<!-- TODO（中文）：暂无 Google Scholar 主页，暂时注释掉 Google Scholar CDN 配置说明。
